...
export default function DashboardPage() {
  ...
  function onTogglePublish(v: Video) {
    ...
    toast({
      ...
      description: v.published
        ? "Your video is now hidden."
        : "Your video is live and visible.",
    });
  }
  ...
  return (
    <main className="p-4 md:p-6">
      <h1 className="text-xl md:text-2xl font-semibold text-foreground text-balance mb-4">
        Dashboard
      </h1>
      <p className="text-muted-foreground">
        Welcome to your dashboard. Add analytics and management widgets here.
      </p>
      ...
      <section id="videos" className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <p className="text-sm text-muted-foreground">
            Manage visibility, edit details, or remove videos.
          </p>
        </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  ...
                  <div className="w-full sm:w-48 overflow-hidden rounded-md ring-1 ring-border">
                    <img
                      src={
                        v.thumbnail ||
                        "/placeholder.svg?height=160&width=280&query=video%20thumbnail"
                      }
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      {v.channelName} • {formatDate(v.createdAt)} •{" "}
                      {Intl.NumberFormat().format(v.views)} views
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                    <div className="flex items-center gap-2">
                      <Switch
                        ...
                        aria-label={
                          v.published ? "Set as unpublished" : "Publish video"
                        }
                      />
